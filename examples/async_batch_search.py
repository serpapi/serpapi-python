    ...
    try:
        ...
        for result in results:
            ...
            if result["success"]:
                ...
                print(f"✓ {result['company']}: {result['organic_count']} results "
        ...
        print()
        print(f"Summary: {len(successful_searches)} successful, {len(failed_searches)} failed")
        ...
        if successful_searches:
            ...
            try:
                ...
                print(f"Archive status: {archived_result.get('search_metadata', {}).get('status', 'Unknown')}")
            except SerpApiError as e:
