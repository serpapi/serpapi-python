...
class Client:
    ...
    def __init__(
        ...
        **kwargs
        ...
        if api_key is None:
            ...
            if api_key is None:
                raise SerpApiError('API key is required. Set api_key parameter or SERPAPI_KEY environment variable.')
    ...
    async def location(self, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        """
    ...
    async def search_archive(
        ...
        return await self._make_request(f'/searches/{search_id}.{format_type}', {}, format_type)
